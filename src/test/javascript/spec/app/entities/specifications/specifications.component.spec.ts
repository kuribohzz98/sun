...
import { SpecificationsComponent } from 'app/entities/specifications/specifications.component';
...
describe('Component Tests', () => {
  describe('Specifications Management Component', () => {
    let comp: SpecificationsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SpecificationsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.specifications && comp.specifications[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
