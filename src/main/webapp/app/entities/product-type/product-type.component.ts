...
export class ProductTypeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.productTypeService
      ...
      .subscribe(
        (res: HttpResponse<IProductType[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInProductTypes(): void {
    this.eventSubscriber = this.eventManager.subscribe('productTypeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProductType[] | null, headers: HttpHeaders, page: number): void {
